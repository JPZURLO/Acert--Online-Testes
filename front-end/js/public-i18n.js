(function () {
  ...
  const translations = {
    ...
    "Use pelo menos 8 caracteres, com letra maiúscula, minúscula e número.": "Use at least 8 characters with an uppercase letter, a lowercase letter and a number.",
    ...
    "O Centro de Testes Online Teste, parte do Grupo ACerT – Academia Brasileira de Certificações e Treinamentos, foi desenvolvido para transformar a forma como avaliações são realizadas.": "The Online Teste Testing Center, part of the ACerT Group – Brazilian Academy of Certifications and Training, was developed to transform how assessments are conducted.",
    "Nosso objetivo é oferecer soluções modernas e eficazes para órgãos certificadores, instituições de ensino, universidades corporativas, empresas e agências de emprego.": "Our goal is to provide modern and effective solutions for certification bodies, educational institutions, corporate universities, companies and recruitment agencies.",
    "Com foco em agilidade, confiabilidade e acessibilidade, proporcionamos resultados rápidos e precisos, sempre com um excelente custo-benefício.": "Focused on agility, reliability and accessibility, we deliver fast and accurate results with excellent value.",
    "Acreditamos que avaliações de qualidade são a base para impulsionar carreiras, negócios e educação.": "We believe quality assessments are the foundation for advancing careers, businesses and education.",
    ...
    "Testes personalizados": "Customized tests",
    ...
    "Inscreva participantes e compartilhe o acesso com segurança.": "Enroll participants and securely share access.",
    "Acompanhe": "Track",
    ...
    "Encontre a solução ideal para sua organização": "Find the ideal solution for your organization",
